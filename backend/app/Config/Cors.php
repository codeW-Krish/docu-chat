...
class Cors extends BaseConfig
{
    ...
    public array $default = [
        ...
        // Additional origins are added via ALLOWED_ORIGINS env var in __construct()
    ...
    public function __construct()
    {
        ...
        // Merge additional origins from ALLOWED_ORIGINS env var
        $extraOrigins = env('ALLOWED_ORIGINS', '');
        if (!empty($extraOrigins)) {
            $origins = array_filter(explode(',', $extraOrigins));
            $this->default['allowedOrigins'] = array_merge(
